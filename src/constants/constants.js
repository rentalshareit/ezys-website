...
export const UPDATE_AVAILABLE_TAG_ITEMS = "UPDATE_AVAILABLE_TAG_ITEMS";
...
export const UPDATE_MISC_CHARGES = "UPDATE_MISC_CHARGES";
...
export const UPDATE_RENTAL_PERIOD = "UPDATE_RENTAL_PERIOD";

export const SHOW_SUBSCRIPTION_DISCLAIMER_MODAL = "SHOW_SUBSCRIPTION_DISCLAIMER_MODAL";
export const DISCLAIMER_CONFIRMED = "DISCLAIMER_CONFIRMED";
export const DISCLAIMER_CANCELLED = "DISCLAIMER_CANCELLED";
export const HIDE_OOS_PRODUCTS = "HIDE_OOS_PRODUCTS";
